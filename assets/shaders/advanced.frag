...
// INS
in vec3 frag_pos; //For incoming fragment position
in vec2 frag_texture;
in vec3 frag_normal; //For incoming normals

// OUTS
out vec4 FragColor; //For outgoing pyramid color to the GPU
...
uniform sampler2D textureGeneral;
...
void main(){
    ...
    vec3 object_color = texture(textureGeneral, frag_texture).xyz;
